...
extern "C"
{
	...
	EMSCRIPTEN_KEEPALIVE void wam_getNumParameters(Processor* proc) { proc->getNumParameters(); }
	EMSCRIPTEN_KEEPALIVE void wam_getParameter(Processor* proc, uint32_t index) { proc->getParameter(index); }
}
